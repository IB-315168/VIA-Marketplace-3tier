...
import com.sep2zg4.viamarket.presentation.model.comm.ClientMarketplaceCommunicator;
...
public class MarketplaceModelManager implements MarketplaceModel
{
   ...
   * @return result of {@link ClientMarketplaceCommunicator#login(int, String)}
   * @throws RemoteException
   */
