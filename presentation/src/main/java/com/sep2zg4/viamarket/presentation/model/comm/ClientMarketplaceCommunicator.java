package com.sep2zg4.viamarket.presentation.model.comm;

import com.sep2zg4.viamarket.presentation.model.MarketplaceModel;
    ...
    implements RemotePropertyChangeListener<String>
{
   ...
   * @return result of {@link RemoteMarketplace#login(int, String)}
   * @throws RemoteException
   */
